...
//==========[ BASE ORI MHANKBARBAR ]========== //MHANKBARBAR BASE
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			wait: '*Proses Sabar Bangh*',
			success: '*Done Bangh',
			error: {
				stick: '⚠︎Error Saat Pembuatan Sticker Bangh⚠︎',
				Iv: '⚠︎Link Nya Erorr Bangh⚠︎'
			},
			only: {
				admin: '⚠︎Fitur Khusus Admin Bangh⚠︎',
				group: '⚠︎Fitur Khusus Grup Bangh⚠︎'
			}
		}
		faketeks = '©snapdxkz' //Ganti Aja Nama Luh
		const isUrl = (url) => {
...
//━━━━━━━━━━━━━━━[ BUTTON ]━━━━━━━━━━━━━━━━━//
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = simple.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "List Haikal","footerText": `_Halo Bangh
🗿
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            itemCount: 2022,
                            status: 1,
                            surface : SnappyXD, //Ganti Aja Nama Luh
                            message: `🗿JAM : ${time}`,
...
var ase = new Date();
                         ...
                         switch(jamss){
  case 0: jamss = "Begadang Ya Bangh🗿"; break;
  case 1: jamss = "Begadang Ya Bangh🗿"; break;
  case 2: jamss = "Begadang Ya Bangh🗿"; break;
  case 3: jamss = "Ga Tidur Bangh🗿"; break;
  case 4: jamss = "Pagi Bangh,Jangan Lupa Sholat🗿"; break;
   case 5: jamss = "Pagi Bangh🗿"; break;
    case 6: jamss = "Pagi Bangh🗿"; break;
     case 7: jamss = "Pagi Bangh🗿"; break;
      case 8: jamss = "Pagi Bangh🗿"; break;
       case 9: jamss = "Pagi Bangh🗿"; break;
         case 10: jamss = "Pagi Bangh🗿"; break;
           case 11: jamss = "Siang Bangh🗿"; break;
             case 12: jamss = "Siang Bangh,Jangan Lupa Sholat🗿"; break;
                 case 13: jamss = "Siang Bangh"; break;
                  case 14: jamss = "Sore Bangh"; break;
                    case 15: jamss = "Sore Bangh,Jangan Lupa Sholat🗿"; break;
                      case 16: jamss = "Sore Bangh🗿"; break;
                       case 17: jamss = "Sore Bangh🗿"; break;
                        case 18: jamss = "Malam.Bangh🗿"; break;
                          case 19: jamss = "Malam Bangh,Jangan Lupa Sholat🗿"; break;
                             case 20: jamss = "Malam Bangh🗿"; break;
                            case 21: jamss = "Malam Bangh🗿"; break;
                          case 22: jamss = "Malam Bangh🗿"; break;
                        case 23: jamss = "Malam Bangh🗿"; break;
...
reply('_*Loading Bangh*_')	
reply('_*Lagi Ngirim Bangh*_')
simple.updatePresence(from, Presence.recording)		
img =  fs.readFileSync('./poto/ngapasiKawan.mp4')
teks = `Halo Bangh ${pushname} 👋${tampilUcapan}
I'M Z-BOT8 ^_^`
trans = `BOT INFO
🗿 _*Nama Bot : ${botname}*_
🗿 _️*Nama Owner : ${ownername}*_
...
_*JIKA BUTTON TIDAK TERLIHAT KETIK .allmenu*_
 ...
 but = [
          { buttonId: `${prefix}command`, buttonText: { displayText: '☮︎MENU☮︎' }, type: 1 },
          { buttonId: `${prefix}grouphaikal`, buttonText: { displayText: '☕︎GROUP NYA SNAPPY☕︎' }, type: 1 },
          { buttonId: `${prefix}userinfo`, buttonText: { displayText: '♧︎︎︎YOUR INFO♧︎︎︎' }, type: 1 },
        ]
...
simple.updatePresence(from, Presence.recording)
   ...
   sendButImage(from, pll, `@snapdxkz`, cewe, [                      
          {
...
//>>>>>>>>>>>>>>>>>>>>[ COMMAND ]<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<//
            ...
            listmenu = [`shop`,`sewabot`,`groupmenu`,`stickermenu`,`downloadmenu`,`islammenu`,`animemenu`,`informationmenu`,`randomtextmenu`,`searchmenu`,`primbonmenu`,`stalkmenu`,`randomimagemenu`,`ownermenu`,`asupanmenu`,`gabut`,`game`,`meme`,`murid`,`djmenu`,`makermenu`,`walisongo`,]
               ...
               const yy = {title: 'SnappyXD',
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: `SnapBotzz`,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
               ...
               listmsg(from, `${tampilUcapan}`, `Halo Bangh ${pushname}, Pilih Menu Disini`, list)
               break
  ...
  case 'walisongo':
               ...
               listmsg(from, `${tampilUcapan}`,   `Halo Bangh *${pushname}*\n©simplelist, _Ini Command Ski Nya_`, list)
               break
...
[`sholawat1`,`sholawat2`,`sholawat3`,`sholawat4`,`sholawat5`,`sholawat6`,`sholawat7`,`sholawat8`,`sholawat9`,] 
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'SnappyXD' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
...
𝐃𝐨𝐧'𝐭 𝐒𝐩𝐚𝐦`
oy =`
*_Jasa Sewa Bot By : ©snapdxkz_*
*>>>>>>>> *LIST HARGA* >>>>>>>>*
[🔥] . _Fitur Bot Banyak And Ada Catalog Menu_

🗿. _*1 Bulan : Rp. 999.999 [ Promo ]*_
🗿. _*1 Tahun : Rp. 999.999.999 [ Promo ]*_
🗿. _*1 Abad : Rp. 999.999.999.999 [ Promo ]*_

 _Jika Anda Minat Bisa Chat Nomer Ini_
_*🍂 Wa.me/6281352402264*_
_Note Jangan Spam_
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe snapdxkz`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
case 'toimg':
simple.updatePresence(from, Presence.recording)
if (!isQuotedSticker) return reply(' reply stickernya bangh')
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `©snapdxkz *V : 2.889H*`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
case 'tovideo':
simple.updatePresence(from, Presence.recording)
if (!isQuotedSticker) return reply('reply stikernya bangh')
reply(mess.wait)
...
for (let _ of anu) {
buttonss = [{buttonId: `${prefix}menu`, buttonText: {displayText: '☮︎MENU☮︎'}, type: 1},{buttonId: `${prefix}sewabot`, buttonText: {displayText: '☯︎SEWA BOT☯︎'}, type: 1}]
const btnbc = {
contentText: `${q}`,
...
tod = `
╭━🔥─BOT INFO─━─🔥━╮
 |Halo Bangh ${pushname} 👋 selamat ${tampilUcapan}
│🔖Nama Bot : ${botname}
...
─`
but = [
{ buttonId: `${prefix}dinda`, buttonText: { displayText: 'Snappy🗿' }, type: 1 }, 
...
sendButton(from, "GOPAY : Gaada", faketeks, but, mek)
break
case 'dana':
simple.updatePresence(from, Presence.recording)
but = [
...
sendButton(from, "DANA : 08813100198", faketeks, but, mek)
break
case 'ovo':
simple.updatePresence(from, Presence.recording)
but = [
...
sendButton(from, "OVO : Gaada", faketeks, but, mek)
break
...
+ 'END:VCARD'.trim()
simple.sendMessage(from, {displayName: `Creator ${owner}`, vcard: vcard2}, contact, 
{ quoted: ftrol, 
})
reply('TUHH NOMER SNAPPY')
break
case 'okh tq bot':
reply('sama-sama bangh') 
break
...
but = [
        ...
        sendButton(from, teks, '©snapdxkz', but, mek)
break
           ...
           case 'cup':
            ...
            simple.updatePresence(from, Presence.recording)
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${humankey}&text=${ini_txt}`).then((gambar) => {
                        simple.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `©snapdxkz`, quoted : ftrol})
                    })
                    break
                case 'arcade8bit':
                case 'battlefield4':
...
{ buttonId: `${prefix}allmenu`, buttonText: { displayText: '☮︎ALLMENU☮︎' }, type: 1 }, 
]
sendButton(from, tod, faketeks, but, mek)
break
...
case 'pdf':
        ptod = "6281352402264@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
       stst = await simple.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
tescok = `${menunya(prefix)}`
Sendbutdocument(from, tescok, "©snapdxkz", fs.readFileSync('./poto/menu.pdf'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./poto/image/thumbnaildokumen.jpg'), filename:`Z-BOT8.pdf`, pageCount: 9999999 },[{ buttonId: `${prefix}menu`, buttonText: { displayText: '🐣OWNER🐣' }, type: 1 }], {quoted:fvid, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} - ${pushname}\nDownload Script`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/x-O0WHkv3uc`}}})
break

case 'allmenu':
simple.updatePresence(from, Presence.recording)
teks =
`_Mau Allmenu Yang Mana Bangh ${pushname}, Silahkan Di Pilih Bangh Yang Penting Jangan Spam_
...
`
but = [
{ buttonId: `${prefix}pdf`, buttonText: { displayText: 'ALL1'}, type: 1 },
